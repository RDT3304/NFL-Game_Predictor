...
update_team_abbreviations('reg season data/merged_data_def_off_st_reg.csv', 'Original Data/nfl_teams.csv', 'reg season data/updated_merged_data.csv')
...
# Example usage
add_win_column('NFL_schedule_results_2022_reg_updated.csv', 'merged_data_def_off_st_reg.csv', 'output_file.csv')
